...
function main_looper(mytree, sumWeight, dict, pusher!, models, 
    ...
    for evt in mytree
        ...
        elseif arrow_making
            ...
            wgt_PRW_DATASF__1up = evt.weight__PRW_DATASF__1up
            wgt_PRW_DATASF__1down = evt.weight__PRW_DATASF__1down
            ...
            sr_SF_inZ, sr_SF_noZ, sr_DF, wgt_PRW_DATASF__1up, wgt_PRW_DATASF__1down
        else
